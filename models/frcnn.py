import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), '../frcnn_utils/pytorch-faster-rcnn/lib'))
sys.path.append(os.path.join(os.path.dirname(__file__), '../frcnn_utils/pytorch-faster-rcnn/tools'))
